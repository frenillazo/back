package acainfo.back.config.exception;
...
import acainfo.back.user.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle DomainException (generic) - catches all domain exceptions from user module
     */
