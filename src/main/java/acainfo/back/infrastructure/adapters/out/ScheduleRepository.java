...
public interface ScheduleRepository extends JpaRepository<Schedule, Long>, JpaSpecificationExecutor<Schedule> {
     ...
     */
    @Query("SELECT s FROM Schedule s WHERE s.group.id = :groupId ORDER BY s.dayOfWeek, s.startTime")
     ...
     * @return list of schedules
     */
    @Query("SELECT s FROM Schedule s WHERE s.group.teacher.id = :teacherId ORDER BY s.dayOfWeek, s.startTime")
     ...
     * @return list of schedules
     */
    @Query("SELECT s FROM Schedule s WHERE s.group.subject.id = :subjectId ORDER BY s.dayOfWeek, s.startTime")
     ...
     * @return list of conflicting schedules
     */
    @Query("SELECT s FROM Schedule s WHERE s.group.teacher.id = :teacherId " +
     ...
     * @return count of schedules
     */
    @Query("SELECT COUNT(s) FROM Schedule s WHERE s.group.teacher.id = :teacherId")
