...
import acainfo.back.infrastructure.adapters.in.dto.CreateScheduleRequest;
import acainfo.back.infrastructure.adapters.in.dto.ScheduleResponse;
import acainfo.back.infrastructure.adapters.in.dto.UpdateScheduleRequest;
...
public class ScheduleController {
    ...
    @Operation(
            ...
            description = "Creates a new weekly time slot for a group. Validates conflicts with teachers and classrooms.",
            responses = {
    ...
    public ResponseEntity<ScheduleResponse> createSchedule(
        ...
        log.info("Creating schedule for group ID: {}", request.getGroupId());
    ...
    @Operation(
            ...
            description = "Retrieves all schedules with optional filtering by group, teacher, classroom, day, or subject.",
            responses = {
    ...
    public ResponseEntity<List<ScheduleResponse>> getAllSchedules(
            @Parameter(description = "Filter by group ID") @RequestParam(required = false) Long groupId,
    ...
    /**
     * Gets all schedules for a specific group.
     */
    @GetMapping("/group/{groupId}")
    @PreAuthorize("hasRole('ADMIN') or hasRole('TEACHER') or hasRole('STUDENT')")
    @Operation(
            summary = "Get schedules by group",
            description = "Retrieves all schedules for a specific group.",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Schedules retrieved successfully",
                            content = @Content(array = @ArraySchema(schema = @Schema(implementation = ScheduleResponse.class)))),
                    @ApiResponse(responseCode = "404", description = "Group not found")
    ...
    /**
     * Deletes all schedules for a group.
     */
    @DeleteMapping("/group/{groupId}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(
            summary = "Delete all schedules for a group",
            description = "Deletes all schedules associated with a specific group.",
            responses = {
