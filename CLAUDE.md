...
- Tests: `JAVA_HOME="C:/Users/pablo/.jdks/ms-21.0.8" ./mvnw test` — **178 tests** (Mockito puro de los servicios críticos + smoke @SpringBootTest H2). Deben estar SIEMPRE en verde.
